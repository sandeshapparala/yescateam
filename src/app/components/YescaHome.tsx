...
const YescaHome = () => {
  ...
  return (
    <div className="font-sans flex flex-col min-h-screen">
      {/* Hero Section */}
      <section ref={heroRef} className="bg-blue-900 text-white py-20 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center hero-buttons">
            <button className="bg-yellow-500 hover:bg-yellow-600 text-blue-900 font-bold px-8 py-3 rounded-full mr-4">
              Join Youth Camp 2025
            </button>
            <button className="bg-transparent border-2 border-white hover:bg-white hover:text-blue-900 text-white font-bold px-8 py-3 rounded-full transition-colors">
              Learn More
            </button>
          </div>
        </div>
      ...
      {/* About Section */}
      <section ref={aboutRef} className="py-16 px-4 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-blue-900">Our Mission</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-gray-50 rounded-lg shadow-md mission-card">
              ...
              <h3 className="text-xl font-bold mb-3 text-blue-800">Faith</h3>
              <p>Building strong foundations in biblical truth and Christian doctrine for young believers.</p>
            </div>
            <div className="text-center p-6 bg-gray-50 rounded-lg shadow-md mission-card">
              <div className="bg-blue-900 text-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
              ...
              <h3 className="text-xl font-bold mb-3 text-blue-800">Fellowship</h3>
              <p>Creating meaningful connections and spiritual community among Christian youth.</p>
            </div>
            <div className="text-center p-6 bg-gray-50 rounded-lg shadow-md mission-card">
              <div className="bg-blue-900 text-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
              ...
              <h3 className="text-xl font-bold mb-3 text-blue-800">Witness</h3>
              <p>Equipping young believers to share their faith and make a difference in their communities.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Scripture Section */}
      <section ref={scriptureRef} className="py-16 px-4 md:px-8 bg-gray-100">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-blue-900">Our Scriptural Foundation</h2>
          <div className="grid md:grid-cols-2 gap-10 max-w-4xl mx-auto">
            <div className="p-8 bg-white rounded-lg shadow-md scripture-card">
              ...
              <p className="font-bold text-blue-800">1 Timothy 4:12</p>
            </div>
            <div className="p-8 bg-white rounded-lg shadow-md scripture-card">
              <p className="text-xl mb-4 italic">
              ...
              <p className="font-bold text-blue-800">Matthew 28:19-20</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Youth Camp Section */}
      <section ref={campRef} className="py-16 px-4 md:px-8 bg-blue-800 text-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="camp-content">
              ...
              <button className="bg-yellow-500 hover:bg-yellow-600 text-blue-900 font-bold px-8 py-3 rounded-full">
                Register Now
              </button>
            </div>
            <div className="bg-white text-blue-900 p-6 rounded-lg camp-stats">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="text-center p-4">
                  <p className="text-4xl font-bold text-blue-800">1000+</p>
                  <p>Lives Transformed</p>
                </div>
                <div className="text-center p-4">
                  <p className="text-4xl font-bold text-blue-800">800+</p>
                  <p>2024 Camp Participants</p>
                </div>
                <div className="text-center p-4">
                  <p className="text-4xl font-bold text-blue-800">1994</p>
                  <p>Year Founded</p>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-gray-900 text-white py-10 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center">
            <h2 className="text-2xl font-bold mb-4">YESCA Team</h2>
            <p className="mb-6">Youth Evangelical Soldiers of Christian Assemblies</p>
