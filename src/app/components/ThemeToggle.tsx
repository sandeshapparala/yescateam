...
const ThemeToggle: React.FC<ThemeToggleProps> = ({ className = '' }) => {
  ...
  if (!mounted) {
    return (
      <div className={`h-12 w-12 rounded-full border border-border bg-background ${className}`} />
    );
  }
  ...
  return (
    <button
      ...
      className={`
        ...
        shadow-md transition-all duration-200 hover:scale-110 hover:shadow-lg
